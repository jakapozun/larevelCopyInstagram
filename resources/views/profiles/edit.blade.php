        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="form-group row mt-3">
                    ...
                    <input id="title" type="text" placeholder="Insert TITLE Here..."
                ...
                <div class="form-group row mt-3">
                    ...
                    <input id="description" type="text" placeholder="Insert DESCRIPTION Here..."
                ...
                <div class="form-group row mt-3">
                    ...
                    <input id="url" type="text" placeholder="Insert URL Here..."
